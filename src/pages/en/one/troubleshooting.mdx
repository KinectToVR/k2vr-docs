...
For the second one, **changing USB port where the Kinect is plugged in and unplugging everything else** may solve the issue. Make sure you've plugged the Kinect adapter in a USB 3.0 port.
